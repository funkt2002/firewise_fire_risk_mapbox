...
def generate_enhanced_solution_html(txt_content, lp_content, parcel_data, weights, session_id='unknown', sa_metrics=None, optimization_type='absolute'):
    ...
    # SA metrics section (if applicable)
        ...
        # Multi-start optimization details
        html_parts.append('<h3>Multi-Start Optimization</h3>')
        html_parts.append('<table style="border-collapse: collapse; margin: 10px 0;">')
        html_parts.append('<tr><td style="padding: 5px; border: 1px solid #ddd;"><strong>Number of Starts:</strong></td>')
        html_parts.append(f'<td style="padding: 5px; border: 1px solid #ddd;">{sa_metrics.get("num_starts", 9)}</td></tr>')
        html_parts.append('<tr><td style="padding: 5px; border: 1px solid #ddd;"><strong>Best Start Type:</strong></td>')
        html_parts.append(f'<td style="padding: 5px; border: 1px solid #ddd;">{sa_metrics.get("best_start_type", "N/A")}</td></tr>')
        html_parts.append('<tr><td style="padding: 5px; border: 1px solid #ddd;"><strong>Improvement over Baseline:</strong></td>')
        html_parts.append(f'<td style="padding: 5px; border: 1px solid #ddd;">{sa_metrics.get("improvement_pct", 0):.1f}%</td></tr>')
        html_parts.append('<tr><td style="padding: 5px; border: 1px solid #ddd;"><strong>Total Improvements:</strong></td>')
        html_parts.append(f'<td style="padding: 5px; border: 1px solid #ddd;">{sa_metrics.get("total_improvements", 0):,}</td></tr>')
        html_parts.append('<tr><td style="padding: 5px; border: 1px solid #ddd;"><strong>Total Acceptances:</strong></td>')
        html_parts.append(f'<td style="padding: 5px; border: 1px solid #ddd;">{sa_metrics.get("total_acceptances", 0):,}</td></tr>')
        html_parts.append('</table>')
        
        # Ranking metrics
        html_parts.append('<h3>Ranking Performance</h3>')
        html_parts.append('<table style="border-collapse: collapse; margin: 10px 0;">')
        html_parts.append('<tr><td style="padding: 5px; border: 1px solid #ddd;"><strong>Average Rank:</strong></td>')
        html_parts.append(f'<td style="padding: 5px; border: 1px solid #ddd;">{sa_metrics.get("avg_rank", 0):.1f}</td></tr>')
        html_parts.append('<tr><td style="padding: 5px; border: 1px solid #ddd;"><strong>Best Rank:</strong></td>')
        html_parts.append(f'<td style="padding: 5px; border: 1px solid #ddd;">{sa_metrics.get("best_rank", 0)}</td></tr>')
        html_parts.append('<tr><td style="padding: 5px; border: 1px solid #ddd;"><strong>Top 10% Rate:</strong></td>')
        html_parts.append(f'<td style="padding: 5px; border: 1px solid #ddd;">{sa_metrics.get("top_10_pct_rate", 0):.1f}%</td></tr>')
        html_parts.append('<tr><td style="padding: 5px; border: 1px solid #ddd;"><strong>Top 25% Rate:</strong></td>')
        html_parts.append(f'<td style="padding: 5px; border: 1px solid #ddd;">{sa_metrics.get("top_25_pct_rate", 0):.1f}%</td></tr>')
        html_parts.append('</table>')
        ...
        html_parts.append(f'<td style="padding: 5px; border: 1px solid #ddd;">{sa_metrics.get("preference_gap", 0):.3f}</td></tr>')
        html_parts.append('<tr><td style="padding: 5px; border: 1px solid #ddd;"><strong>Avg Selected Score:</strong></td>')
        html_parts.append(f'<td style="padding: 5px; border: 1px solid #ddd;">{sa_metrics.get("avg_selected_score", 0):.3f}</td></tr>')
        html_parts.append('<tr><td style="padding: 5px; border: 1px solid #ddd;"><strong>Avg Non-Selected Score:</strong></td>')
        html_parts.append(f'<td style="padding: 5px; border: 1px solid #ddd;">{sa_metrics.get("avg_non_selected_score", 0):.3f}</td></tr>')
        html_parts.append('<tr><td style="padding: 5px; border: 1px solid #ddd;"><strong>Parcels Analyzed:</strong></td>')
        html_parts.append(f'<td style="padding: 5px; border: 1px solid #ddd;">{sa_metrics.get("parcels_analyzed", 0):,}</td></tr>')
        html_parts.append('</table>')
        
        html_parts.append('<p><em><strong>Multi-Start Simulated Annealing:</strong> This method uses 9 different starting points (3 analytical, 3 semi-random, 3 random) ')
        html_parts.append('to find globally optimal weights that minimize the average rank of your selected parcels. ')
        html_parts.append('The algorithm uses an adaptive cooling schedule with probabilistic acceptance of worse solutions to escape local optima. ')
        html_parts.append(f'The best solution ({sa_metrics.get("best_start_type", "N/A")} start) achieved {sa_metrics.get("improvement_pct", 0):.1f}% improvement over the baseline.</em></p>')

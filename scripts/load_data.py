...
def main():
    ...
    parser.add_argument('--db-url', default=os.environ.get('DATABASE_URL', 'postgres://postgres:EdcbDbbFbDB5235FCD4B1dBAaDBCcc31@switchyard.proxy.rlwy.net:22560/railway'),
